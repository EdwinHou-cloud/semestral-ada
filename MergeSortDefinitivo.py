...
class VisualizadorMergeSort: 
    ...
    def __init__(self, root): 
        ...
        self.root.geometry("1100x750")  # Tamaño de la ventana
    ...
    def mostrar_presentacion(self):
        ...
        # Crear el texto en el lienzo
        self.lienzo.create_text(550, 200, text=texto_presentacion, font=("Arial", 14), fill="black", justify="center", tags="presentacion_texto")
